var GEN;
        ...
        function sendGenerateData() {
            ...
            fetch("http://localhost:5001/api/ga/results", {
                method: "post",
                headers: {
                ...
                showLoader(false);
                console.log(data);
                var generation = data.matingPool.map(function(dot) {
                    return new Dot2(dot.dna);
                });
        ...
        function Dot2(dna) {
            ...
            this.move = function() {
                ...
                if (!this.direction) {
                    ...
                    var dirType = DIR_TYPES[nextMove];
                ...
                var newPosX = this.pos.x + this.direction.speedX;
                var newPosY = this.pos.y + this.direction.speedY;
